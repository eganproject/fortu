...
@section('title', 'Edit Service - AdminPanel')
...
@section('content')
    ...
    <div x-data="{
        ...
        <h2 class="text-2xl font-bold text-slate-800 p-6">Ubah Service</h2>
        <div class="md:px-8">
            <form action="/admin/web-preferences/services/{{ $service->id }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div
                        ...
                        <template x-if="image_1">
                            <img :src="image_1"
                                alt="Pratinjau Gambar Latar" class="w-full h-full object-cover">
                        </template>
                    </div>
                    <input type="file" id="image_1" name="image_1"
                        ...
                        @change="image_1 = URL.createObjectURL($event.target.files[0])">
                ...
                <div>
                    ...
                    <input type="file" id="image_2" name="image_2"
                        class="mt-4 block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200"
                        @change="image_2 = URL.createObjectURL($event.target.files[0])">
